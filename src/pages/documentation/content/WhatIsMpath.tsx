...
const WhatIsMpath: React.FC = () => {
    return (
        <div className="prose prose-slate max-w-none">
            <h1 className="text-3xl font-extrabold text-slate-900 mb-6">What is Mpath?</h1>
            
            <p className="text-lg text-slate-600 mb-6 leading-relaxed">
                <strong>Mpath</strong> is a cutting-edge, browser-based SAN fabric path validation and observability platform. 
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-6 my-8">
                ...
                <p className="text-indigo-700 text-sm">
                    Mpath operates under a strict Zero-Trust philosophy. The application runs <strong>entirely locally</strong> within your browser's memory. No configuration data, aliases, or WWNs are ever uploaded to an external server, ensuring complete compliance with stringent enterprise security policies.
                </p>
            </div>
